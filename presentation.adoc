...
* SHA-1 is weak and vulnerable to collisions
* Git has supported SHA-256 as an option since 2020 (Git 2.29)
...
** Other types recursively convert all object references
...
[source]
----
100755 blob de1ff864399ea3f3b926a1b79c8c0d41b9b50408    bootstrap
----
...
[source]
----
100755 blob 26444e22e496e27dc608d36e349b53836f893d045c46255c19ffc1c7865aba90    bootstrap
----
...
** For instance, could be used to offer insecure code in one algorithm
...
** Shallow clones and fetches for protocol v2

== What's Next: To Be Written

* Lots of tests
* Various cleanup
** For instance, avoid recursion over untrusted data in favour of iteration
* Shallow clones and fetches for protocol v0
* Shallow pushes
* Partial clones
* Submodule support
...
** Preserve the efficiency of a repository
...
** Generally helpful for users and forges as well
